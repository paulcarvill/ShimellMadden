...
Item.create([
	...
	archive: true,
	categories: [categories[2]],
	imageStyleOne: File.open(Rails.root.join("db/seeds/ShimellMaddenImages","12_1280_800_ratio.jpg")),
	project_id: projects[0].id
	},
	{
	name: "Item 13",
	...
	imageStyleOne: File.open(Rails.root.join("db/seeds/ShimellMaddenImages","13_1280_800_ratio.jpg")),
	project_id: projects[0].id
	},
	{
	name: "Item 14",
	...
	imageStyleOne: File.open(Rails.root.join("db/seeds/ShimellMaddenImages","14_800_1280_ratio.jpg")),
	project_id: projects[0].id
	},
	{
	name: "Item 15",
	...
	archive: true,
	categories: [categories[1]],
	imageStyleOne: File.open(Rails.root.join("db/seeds/ShimellMaddenImages","15_1280_800_ratio.jpg")),
	project_id: projects[0].id
	},
	{
	name: "Item 16",
	...
	archive: true,
	categories: [categories[1]],
	imageStyleOne: File.open(Rails.root.join("db/seeds/ShimellMaddenImages","16_800_1280_ratio.jpg")),
	...
	archive: true,
	categories: [categories[2]],
	imageStyleOne: File.open(Rails.root.join("db/seeds/ShimellMaddenImages","17_1280_800_ratio.jpg")),
	...
	archive: true,
	categories: [categories[1]],
	imageStyleOne: File.open(Rails.root.join("db/seeds/ShimellMaddenImages","18_1280_800_ratio.jpg")),
	...
	archive: true,
	categories: [categories[3]],
	imageStyleOne: File.open(Rails.root.join("db/seeds/ShimellMaddenImages","19_1280_800_ratio.jpg")),
	...
	archive: true,
	categories: [categories[2]],
	imageStyleOne: File.open(Rails.root.join("db/seeds/ShimellMaddenImages","20_1280_800_ratio.jpg")),
	project_id: projects[3].id,
	...
	archive: true,
	categories: [categories[2]],
	imageStyleOne: File.open(Rails.root.join("db/seeds/ShimellMaddenImages","21_1280_800_ratio.jpg")),
	project_id: projects[2].id,
	...
	archive: true,
	categories: [categories[2]],
	imageStyleOne: File.open(Rails.root.join("db/seeds/ShimellMaddenImages","22_1280_800_ratio.jpg")),
